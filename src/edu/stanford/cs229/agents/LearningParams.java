...
public class LearningParams {
  ...
  public static boolean PROCEED_TO_NEXT_LEVEL_AFTER_COMPLETION = true;
  public static boolean VISUALISE_LEARNING = true;
  public static boolean VISUALISE_TESTING = false;
  ...
  public static int NUM_MODES_TO_TRAIN = 1; //Number of Mario modes to train (small, big, fire)
