...
public class Utils {
  ...
  private static boolean dump(String content, BufferedWriter writer ) {
    try {
  ...
  public static boolean dump(String filename, String content, String header) {
	    Logger.println(1, "** Dumping to " + filename + " **");
	    try {
	      BufferedWriter writer = new BufferedWriter(new FileWriter(filename));
	      writer.write(header + "\n");
